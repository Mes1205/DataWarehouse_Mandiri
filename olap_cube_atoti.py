...
#
# Source data:
#   Tabel Star Schema yang sudah diisi oleh main.py / etl_dimensi.py /
#   etl_fakta.py: fact_transaksi, dim_waktu, dim_nasabah, dim_channel,
...
#   3. Jalankan: python olap_cube_atoti.py
...
def build_cube():
    ...
    # punya pasangan (referential integrity terjaga, lihat etl_dimensi.py).
    ...
    # (lihat etl_dimensi.py: dim_waktu_clean.csv sudah berisi nama bulan/hari Inggris)
...
def run_sample_queries(cube):
    ...
    print(cube.query(m["Total Volume Transaksi"], m["Jumlah Transaksi"], levels=[l["nama_channel"]]))
    ...
    print(cube.query(m["Jumlah Transaksi"], levels=[l["kota"], l["nama_channel"]]))
